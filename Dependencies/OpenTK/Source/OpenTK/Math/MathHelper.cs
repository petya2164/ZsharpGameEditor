...
namespace OpenTK
{
    ...
    public static class MathHelper
    {
        ...
        /// <summary>
        /// Implementation of GLU UnProject
        /// </summary>
        public static Vector3 UnProject(Vector3 screen, ref Matrix4 projection, ref Matrix4 view, int[] viewport)
        {
            Vector4 vec;

            // Map x and y from window coordinates 
            vec.X = (screen.X - viewport[0]) / (float) viewport[2];
            vec.Y = (screen.Y - viewport[1]) / (float) viewport[3];            
            // Map to range -1 to 1 
            vec.X = vec.X * 2.0f - 1.0f;
            vec.Y = vec.Y * 2.0f - 1.0f;
            vec.Z = screen.Z * 2.0f - 1.0f;
            vec.W = 1.0f;            
