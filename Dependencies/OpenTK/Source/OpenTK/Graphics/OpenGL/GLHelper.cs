...
#pragma warning disable 1573
        ...
        public static void Material(int face, int pname, Vector4 @params)
        {
            unsafe { Material(face, pname, (float*) &@params.X); }
        }

        public static void Material(int face, int pname, Color4 @params)
        {
        ...
        public static void Light(int name, int pname, Vector4 @params)
        {
            unsafe { GL.Light(name, pname, (float*) &@params.X); }
        }

        public static void Light(int name, int pname, Color4 @params)
        {
        ...
        {
            int length;
            GetProgram(program, OpenGL.ProgramParameter.ACTIVE_UNIFORM_MAX_LENGTH, out length);
            StringBuilder sb = new StringBuilder(length == 0 ? 1 : length * 2);
        ...
        {
            int length;
            GetProgram(program, OpenGL.ProgramParameter.ACTIVE_UNIFORM_BLOCK_MAX_NAME_LENGTH, out length);
            StringBuilder sb = new StringBuilder(length == 0 ? 1 : length * 2);
        ...
        public static void GetShaderInfoLog(int shader, out string info)
        {
            ...
            {
                int length;
                GL.GetShader( shader, ShaderParameter.INFO_LOG_LENGTH, out length);
                if (length == 0)
                {
                    info = String.Empty;
                    return;
        ...
        public static void GetProgramInfoLog(int program, out string info)
        {
            ...
            {
                int length;
                GL.GetProgram(program, OpenGL.ProgramParameter.INFO_LOG_LENGTH, out length); if (length == 0)
                {
                    info = String.Empty;
                    return;
                }
        ...
        {
            GL.PointParameter(PointParameterName.POINT_SPRITE_COORD_ORIGIN, (int) param);
        }
