                    ...
                    if (a.StartsWith("--") || a.StartsWith("-") || a.StartsWith("/"))
                    {
                        ...
                        switch (b[0])
                        {
                            ...
                            case "option":
                                ...
                                Settings.Compatibility |= b[1].ToLower() == "nodebug" ? Settings.Legacy.NoDebugHelpers : Settings.Legacy.None;
                                Settings.Compatibility |= b[1].ToLower() == "const_int_enums" ? Settings.Legacy.ConstIntEnums : Settings.Legacy.None;
                                break;
                            default:
