...
namespace Microsoft.Samples.VisualStudio.SynchronousXmlDesigner.TreeXmlEditor
{
    ...
    /// </summary>
    internal class TreeNodeProperties
    {
        
        // Properties holder for the XmlNode
        //private XmlNodeProperties properties;
        private CustomClass properties;
        ...
        /// </summary>
        public TreeNodeProperties(XmlNode node)
        {
            if (node == null)
            {
                return;
        ...
        /// </summary>
        internal CustomClass Properties
        {
            get 
            {
                return properties; 
        ...
        /// <summary>
        /// Gets TreeViewEditor.TreeViewImagesList value used to display current XmlNode.
        /// </summary>
        public TreeViewEditor.TreeViewImagesList NodeImageIndex
        {
            get
            {
                ...
                {
                    // root node
                    return TreeViewEditor.TreeViewImagesList.ImageIndexGroup;
                }
                else if (IsLeafNode(this.xmlNode))
                {
                    return TreeViewEditor.TreeViewImagesList.ImageIndexValue;
                }
                else
                {
                    return TreeViewEditor.TreeViewImagesList.ImageIndexNode;
                }
            }
        }
        ...
        /// </summary>
        public TreeNodeProperties AddNewChild(string childName)
        {
            bool needCommit = false;
            statusString = String.Empty;
            TreeNodeProperties props = null;
...
//                 }
                ...
                props = new TreeNodeProperties(newXmlNode);
        ...
        private bool ChangeElementNodeText(string newValue)
        {
            bool needCommit = false;
        ...
        internal void PropertyHolderChanged(Object sender, PropertyChangedEventArgs e)
        {
            ...
            switch (e.Action)
            {
                case PropertyChangeAction.ElementNodeRenamed:
                    ...
                    break;
                case PropertyChangeAction.NodeTextChanged:
                    needCommit = ChangeElementNodeText(e.NewValue);
                    break;
                case PropertyChangeAction.AttributesCollectionChanged:
                    UpdateAttributes();
                    break;
                default:
                    needCommit = false;
