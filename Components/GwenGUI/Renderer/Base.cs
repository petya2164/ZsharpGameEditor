...
namespace Gwen.Renderer
{
    ...
    public class RendererBase : IDisposable
    {
        ...
        public virtual void DrawTexturedRect(Texture t, Rectangle targetRect)
        {
            DrawTexturedRect(t, targetRect, 0, 0, 1, 1);
        }

        public virtual void DrawTexturedRect(Texture t, Rectangle targetRect, float u1, float v1, float u2, float v2) //0,0,1,1
        {}
        ...
        public virtual void DrawShavedCornerRect(Rectangle rect)
        {
            DrawShavedCornerRect(rect, false);
        }
        public virtual void DrawShavedCornerRect(Rectangle rect, bool slight)
        {
            // Draw INSIDE the w/h.
            rect.Width -= 1;
            rect.Height -= 1;
