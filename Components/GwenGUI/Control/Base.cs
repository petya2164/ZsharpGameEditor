...
#region Fields
        ...
        public virtual void SetSkin(Skin.Base skin, bool doChildren)
        {
            if (m_Skin == skin)
                return;
            m_Skin = skin;
        ...
        protected virtual bool OnMouseMoved(int x, int y, int dx, int dy)
        {
            return true;
        }
        ...
        /// </summary>
        internal bool InputMouseMoved(int x, int y, int dx, int dy)
        {
            return OnMouseMoved(x, y, dx,  dy);
        }
        ...
        protected virtual bool OnMouseClickedLeft(int x, int y, bool down)
        {
            return true;
        }
        ...
        /// </summary>
        internal bool InputMouseClickedLeft(int x, int y, bool down)
        {
            return OnMouseClickedLeft(x, y, down);
        }
        ...
        /// <param name="y">Y coordinate.</param>
        /// <param name="down">If set to <c>true</c> mouse button is down.</param>
        protected virtual bool OnMouseClickedRight(int x, int y, bool down)
        {
            return true;
        }
        ...
        /// </summary>
        internal bool InputMouseClickedRight(int x, int y, bool down)
        {
            return OnMouseClickedRight(x, y, down);
        }
        ...
        /// <param name="x">X coordinate.</param>
        /// <param name="y">Y coordinate.</param>
        protected virtual bool OnMouseDoubleClickedLeft(int x, int y)
        {
            // use the normal clicked event as the default handler
            return OnMouseClickedLeft(x, y, true); // [omeg] should this be called?
        }

        /// <summary>
        /// Invokes left double mouse click event (used by input system).
        /// </summary>
        internal bool InputMouseDoubleClickedLeft(int x, int y)
        {
            return OnMouseDoubleClickedLeft(x, y);
        }
        ...
        /// <param name="x">X coordinate.</param>
        /// <param name="y">Y coordinate.</param>
        protected virtual bool OnMouseDoubleClickedRight(int x, int y)
        {
            // use the normal clicked event as the default handler
            return OnMouseClickedRight(x, y, true); // [omeg] should this be called?
        }

        /// <summary>
        /// Invokes right double mouse click event (used by input system).
        /// </summary>
        internal bool InputMouseDoubleClickedRight(int x, int y)
        {
            return OnMouseDoubleClickedRight(x, y);
        }
        ...
        public virtual ControlBase GetControlAt(int x, int y)
        {
            ...
            if (!MouseInputEnabled) return null;
        ...
        // giver
        public virtual void DragAndDrop_SetPackage(bool draggable, String name, object userData)
        {
            if (m_DragAndDrop_Package == null)
            {
        ...
        /// <returns>True if bounds changed.</returns>
        public virtual bool SizeToChildren() // true, true 
        {
            return SizeToChildren(true, true);
        }

        public virtual bool SizeToChildren(bool width, bool height) // true, true
        {
        ...
        public virtual void Anim_WidthIn(float length, float delay, float ease) // 0, 1
        {
