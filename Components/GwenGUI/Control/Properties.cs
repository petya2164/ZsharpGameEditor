...
namespace Gwen.Control
{
    ...
    /// Properties table.
    /// </summary>
    public class Properties : GUIControl
    {
        ...
        protected virtual void OnSplitterMoved(GUIControl control)
        {
        ...
        public PropertyRow Add(String label)
        {
            return Add(label, "");
        }
        ...
        private void OnRowValueChanged(GUIControl control)
        {
