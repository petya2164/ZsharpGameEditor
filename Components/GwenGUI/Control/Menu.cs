...
namespace Gwen.Control
{
    ...
    public class Menu : ScrollControl
    {
        ...
        {
            return AddItem(text, String.Empty, String.Empty);
        }
        public virtual MenuItem AddItem(String text, String iconName)
        {
            return AddItem(text, iconName, String.Empty);
        }
