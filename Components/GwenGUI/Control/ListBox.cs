...
namespace Gwen.Control
{
    ...
    public class ListBox : ScrollControl
    {
        ...
        public void SelectRow(int index, bool clearOthers)
        {
        ...
        /// <param name="clearOthers">Determines whether to deselect previously selected rows.</param>
        public void SelectRows(String rowText, bool clearOthers)
        {
        ...
        {
            SelectRowsByRegex(pattern, RegexOptions.None, false);
        }
        public void SelectRowsByRegex(String pattern, RegexOptions regexOptions, bool clearOthers)
        {
