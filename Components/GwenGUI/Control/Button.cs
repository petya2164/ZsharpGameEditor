...
namespace Gwen.Control
{
    ...
    public class Button : Label
    {
        ...
        public virtual void SetImage(String textureName)
        {
            SetImage(textureName, false);
        }

        public virtual void SetImage(String textureName, bool center)
        {
        ...
        /// <param name="x">X coordinate.</param>
        /// <param name="y">Y coordinate.</param>
        protected override bool OnMouseDoubleClickedLeft(int x, int y)
        {
