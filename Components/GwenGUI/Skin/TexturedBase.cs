...
namespace Gwen.Skin
{
    ...
    public class TexturedBase : Skin.Base
    {
        ...
        private void DrawActiveTabButton(Control.GUIControl control, Pos dir)
        {
            if (dir == Pos.Top)
            {
        ...
        public override void DrawKeyboardHighlight(Control.GUIControl control, Rectangle r, int offset)
        {
            Rectangle rect = r;
        ...
        public override void DrawComboBoxArrow(Control.GUIControl control, bool hovered, bool down, bool open, bool disabled)
        {
            if (disabled)
            {
